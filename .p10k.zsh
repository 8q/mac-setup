# Generated by Powerlevel10k configuration wizard on 2020-06-08 at 14:26 JST.
...
# left frame, lightest-ornaments, compact, many icons, concise, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_OK=no
